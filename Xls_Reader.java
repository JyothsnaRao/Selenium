package aphis.arm.autotest.utilities;
...
public class Xls_Reader {
	public static String filename = System.getProperty("user.dir")
			+ "\\src\\main\\resources\\"
			+ "aphis\\arm\\autotest\\xls\\SimulateTestdataSuite.xlsx";
	public String path;
	...
	public boolean setCellData(String sheetName, String colName, int rowNum,
		...
		try {
			...
			// New code to add colors to pass or fail
			short color = -1;
			if (data != null) {
				...
				if (data.trim().equalsIgnoreCase("Pass")) {
					color = HSSFColor.GREEN.index;
				} else if (data.trim().equalsIgnoreCase("Fail")) {
	...
	// returns true if data is set successfully else false
	public boolean setCellData(String sheetName, int rowNum, int colNumb,
			String data) {
		try {
			fis = new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);
	...
	public static void main(String arg[]) throws IOException {
		...
		datatable = new Xls_Reader(
				"C:\\SimulationTestdataSuite\\src\\Framework_XL_Files\\Controller.xlsx");
